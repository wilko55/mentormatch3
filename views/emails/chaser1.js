...
let chaser1 = function (userData, recepientData, emailData) {
  ...
  return `
        ...
        <div style="background:#f5f6f9;color:#666;font-family:Helvetica,arial,sans-serif;max-width:500px;padding:20px" bgcolor="#F5F6F9">
          ...
          <p style="font-size:14px;line-height:21px;margin-bottom:21px">A week ago you received a message from ` + userData.name + ` on <a href="http://www.mentormatch.org.uk" style="color:#469abd;text-decoration:underline" target="_blank">mentormatch.org.uk</a></p>
          <blockquote>`
            + emailData.newBody +
          `</blockquote>
          ...
          <p style="font-size:14px;line-height:21px;margin-bottom:21px">
            Please click here to <a href="` + replyLink + `" target="_blank" style="text-decoration:none"><span style="padding:5px; background-color: #04AAC9 ;color:#FFFFFF;">reply to ` + userData.name + ` now</span></a>.
          </p>
          <p style="font-size:14px;line-height:21px;margin-bottom:21px">
            If <a href="` + notRightLink + `" target="_blank" style="text-decoration:none"><span style="padding:5px; background-color: #04AAC9 ;color:#FFFFFF;">now isn't the right time</span></a> for you we can send the person an automated message to let them know. for you, we can send the person an automated message to let them know.
          </p>
          <p style="font-size:14px;line-height:21px;margin-bottom:21px">
